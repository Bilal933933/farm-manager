    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'تم تفعيل التحقق بخطوتين. امسح رمز QR أو أدخل مفتاح الإعداد في تطبيق المصادقة.',
                buttonText: 'إغلاق',
            };
        }
        ...
        return {
            ...
            description:
                'لإنهاء تفعيل التحقق بخطوتين، امسح رمز QR أو أدخل مفتاح الإعداد في تطبيق المصادقة',
            buttonText: 'متابعة',
        };
