...
| Products | كتالوج الأصناف (سماد، مبيد، بذور...) — اكتمل |
| StockMovements | حركات المخزون (دخول/خروج، جرد، إتلاف...) — اكتمل |
| Purchases | المشتريات (فواتير، مرتجعات) — قادم |
| Ledger | الحركات المالية (دفتر الأستاذ — يُولَّد تلقائيًا) |
| Reports | التقارير — لاحقًا |

**ترتيب البناء:** Lands → Parties → Products → StockMovements ← (نحن هنا) → Purchases → Ledger
