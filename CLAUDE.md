...
| Products | المنتجات الزراعية والمصنّعة |
| Inventory | المخزون (أصناف، كميات، مستودعات) |
| Purchases | المشتريات (طلبات، فواتير، مرتجعات) |
| Ledger | الحركات المالية (دفتر الأستاذ) |
| Reports | التقارير (ربح، كشف حساب مزارع، كشف حساب مورد، تقرير موسم، تقرير مخزون) |

**الترتيب المتوقع للبناء:** Roles → Parties → PartyRoles → Lands → LandContracts → LandSeasons → Products → Inventory → Purchases → Ledger → Reports
...
- **PartyRoles**: العلاقة بين Party والدور (مورد/مزارع/مالك...) لم تُبنَ بعد.
