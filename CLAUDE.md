...
| Products | كتالوج الأصناف (سماد، مبيد، بذور، أدوات...) — اكتمل |
| Inventory | المخزون — قادم |
| Purchases | المشتريات (فواتير، مرتجعات) |
| Ledger | الحركات المالية (دفتر الأستاذ — يُولَّد تلقائيًا من العمليات) |
| Reports | التقارير (ربح، كشف حساب، تقرير موسم، تقرير مخزون) |

**ترتيب البناء:** Lands → Parties → Products ← (نحن هنا) → Inventory → Purchases → Ledger
