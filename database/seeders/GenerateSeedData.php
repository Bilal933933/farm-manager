...
// ──────────────────────────────────────────────
$lands = [
    ['ref' => 'land_salam',    'name' => 'أرض السلام',    'location' => 'كفر الشيخ - مركز بيلا - ناحية السلام',              'area' => 12, 'area_unit' => 'فدان', 'status' => 'نشط', 'notes' => 'أرض خصبة مجهزة بالري المحوري'],
    ['ref' => 'land_tar3a',    'name' => 'أرض الترعة',    'location' => 'كفر الشيخ - مركز الرياض - بجوار ترعة النوبارية',    'area' => 8,  'area_unit' => 'فدان', 'status' => 'نشط', 'notes' => 'أرض حديثة الري بالغمر'],
    ['ref' => 'land_nile',     'name' => 'أرض النيل',     'location' => 'الأقصر - الضفة الغربية - نجع الأمل',               'area' => 15, 'area_unit' => 'فدان', 'status' => 'نشط', 'notes' => 'أرض رسوبية على ضفاف النيل'],
    ['ref' => 'land_wadi',     'name' => 'مزرعة الوادي',  'location' => 'الوادي الجديد - مركز الخارجة - منطقة الأربعين',    'area' => 25, 'area_unit' => 'فدان', 'status' => 'نشط', 'notes' => 'مزرعة بالصحراء الغربية - ري محوري'],
    ['ref' => 'land_amal',     'name' => 'حقل الأمل',     'location' => 'الشرقية - مركز الزقازيق - ناحية الأمل',            'area' => 10, 'area_unit' => 'فدان', 'status' => 'نشط', 'notes' => 'أرض طينية جيدة الصرف'],
];
...
$contracts = [
    ...
    [
        ...
        'end_date' => '2026-12-31',
        'amount' => 186000,
        'notes' => 'عقد تأجير أرض السلام - 5,166 جنيه للفدان سنوياً',
    ],
    ...
    [
        ...
        'end_date' => '2026-12-31',
        'amount' => 120000,
        'notes' => 'عقد تأجير أرض الترعة - 5,000 جنيه للفدان سنوياً',
    ],
    ...
    [
        ...
        'end_date' => '2026-12-31',
        'amount' => 225000,
        'notes' => 'عقد تأجير أرض النيل - 5,000 جنيه للفدان سنوياً',
    ],
    ...
    [
        ...
        'end_date' => '2026-12-31',
        'amount' => 350000,
        'notes' => 'عقد تأجير مزرعة الوادي - 4,667 جنيه للفدان سنوياً',
    ],
